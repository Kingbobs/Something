...
class EventListener implements Listener
{
    ...
    public function onPlayerInteractEvent(PlayerInteractEvent $event): void
    {
        ...
        if ($item->getId() == Item::NETHERSTAR) {
            $usrdmg = $pureperms->getUserDataMgr();
            if ($item->getNamedTag()->hasTag("fixc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("feedc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("healc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("nickc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("topc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("fixallc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("backc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("suicidec")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("nearc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("condensec")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("compassc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("clearinvc")) {
                $event->setCancelled();
        ...
        if ($item->getId() == Item::ENDER_EYE) {
            ...
            if ($item->getNamedTag()->hasTag("zeusc")) {
                $item2 = Item::get(Item::DIAMOND_CHESTPLATE);
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("kronosc")) {
                $event->setCancelled();
                $enchantment = Enchantment::getEnchantment(0);
                $enchants = new EnchantmentInstance($enchantment, 4);
                $enchantment1 = Enchantment::getEnchantment(9);
            ...
            if ($item->getNamedTag()->hasTag("hadesc")) {
                $event->setCancelled();
                $enchantment = Enchantment::getEnchantment(0);
                $enchants = new EnchantmentInstance($enchantment, 3);
                $enchantment1 = Enchantment::getEnchantment(9);
                $enchants1 = new EnchantmentInstance($enchantment1, 3);
                $enchantment2 = Enchantment::getEnchantment(122);
                $enchants2 = new EnchantmentInstance($enchantment2, 2);
                $enchantment3 = Enchantment::getEnchantment(115);
                $enchants3 = new EnchantmentInstance($enchantment3, 2);
                $enchantment4 = Enchantment::getEnchantment(109);
                $enchants4 = new EnchantmentInstance($enchantment4, 2);
                ...
                $item8->addEnchantment($enchants1);
                $item8->addEnchantment($enchants2);
                $item8->addEnchantment($enchants3);
                $item8->addEnchantment($enchants4);
                $inventory = $player->getInventory();
                $inventory->addItem($item1, $item2, $item3, $item4, $item8, $item11, $item7);
                $inventory->removeItem($inventory->getItemInHand()->pop());
                return;
            }
            if ($item->getNamedTag()->hasTag("godc")) {
                $event->setCancelled();
                $enchantment = Enchantment::getEnchantment(0);
            ...
            if ($item->getNamedTag()->hasTag("demigodc")) {
                $event->setCancelled();
                $enchantment = Enchantment::getEnchantment(0);
                $enchants = new EnchantmentInstance($enchantment, 2);
                $enchantment1 = Enchantment::getEnchantment(9);
        ...
        if ($item->getId() == Item::FEATHER) {
            $inventory = $player->getInventory();
            $usrdmg = $pureperms->getUserDataMgr();
            if ($item->getNamedTag()->hasTag("colorchatc")) {
                $event->setCancelled();
            ...
            if ($item->getNamedTag()->hasTag("antiafkc")) {
                $event->setCancelled();
        ...
        if ($item->getId() == Item::ENDER_CHEST) {
            $inventory = $player->getInventory();
