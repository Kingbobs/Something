...
class HealCCommand extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::YELLOW . "Heal Command" . TextFormat::BOLD . TextFormat::WHITE . " Charm");
                    $lore = [
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("healc", 1);
                ...
                $sender->sendMessage("Usage: /healc <player>");
            }
        } else {
