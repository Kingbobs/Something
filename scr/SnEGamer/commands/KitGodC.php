...
class KitGodC extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::GOLD . "God Kit" . TextFormat::BOLD . TextFormat::WHITE . " Charm");
                    $lore = [
                        TextFormat::GRAY . "Right-Click to redeem the " . TextFormat::AQUA . "god kit" . TextFormat::GRAY . ",",
                        TextFormat::GRAY . "and gain all the kit's items!"
                    ];
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("godc", 1);
                ...
                $sender->sendMessage("Usage: /godc <player>");
            }
        } else {
