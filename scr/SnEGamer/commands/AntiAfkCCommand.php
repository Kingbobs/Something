...
class AntiAfkCCommand extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::GREEN . "Anti Afk" . TextFormat::BOLD . TextFormat::WHITE . " charm");
                    $lore = [
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("antiafkc", 1);
                ...
                $sender->sendMessage("Usage: /antiafkc <player>");
            }
        } else {
