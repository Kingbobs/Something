            ...
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $lore = [
                        ...
                        TextFormat::RESET .TextFormat::WHITE . "* 1x Wolf Spawner",
                        TextFormat::WHITE . "* 1x Sheep Spawner",
                        TextFormat::WHITE . "* 1x Mooshroom Spawner",
                        TextFormat::WHITE . "* 1x Pig Spawner",
                        " ",
