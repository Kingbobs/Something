...
class CondenseCCommand extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::YELLOW . "Condense Command" . TextFormat::BOLD . TextFormat::WHITE . " charm");
                    $lore = [
                        TextFormat::GRAY . "Right-Click to redeem this command charm",
                        TextFormat::GRAY . "and gain access to the " . TextFormat::AQUA . "condense command!",
                        TextFormat::GRAY . " ",
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("condensec", 1);
                ...
                $sender->sendMessage("Usage: /condensec <player>");
            }
        } else {
