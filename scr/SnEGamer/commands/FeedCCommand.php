...
class FeedCCommand extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::YELLOW . "Feed Command" . TextFormat::BOLD . TextFormat::WHITE . " charm");
                    $lore = [
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("feedc", 1);
                ...
                $sender->sendMessage("Usage: /feedc <player>");
            }
        } else {
