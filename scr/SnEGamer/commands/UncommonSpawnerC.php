            ...
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $lore = [
                        ...
                        TextFormat::RESET .TextFormat::WHITE . "* 1x Creeper Spawner",
                        TextFormat::WHITE . "* 1x Zombie Spawner",
                        TextFormat::WHITE . "* 1x Spider Spawner",
                        TextFormat::WHITE . "* 1x Skeleton Spawner",
                        " ",
