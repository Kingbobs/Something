...
class ClearInvCCommand extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::YELLOW . "Clear Command" . TextFormat::BOLD . TextFormat::WHITE . " charm");
                    $lore = [
                        TextFormat::GRAY . "Right-Click to redeem this command charm",
                        TextFormat::GRAY . "and gain access to the " . TextFormat::AQUA . "clear command!",
                        TextFormat::GRAY . " ",
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("clearinvc", 1);
                ...
                $sender->sendMessage("Usage: /clearinvc <player>");
            }
        } else {
