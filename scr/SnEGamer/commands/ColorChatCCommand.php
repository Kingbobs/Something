...
class ColorChatCCommand extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::GREEN . "Color Chat" . TextFormat::BOLD . TextFormat::WHITE . " charm");
                    $lore = [
                        TextFormat::GRAY . "Right-Click to redeem this perk charm",
                        TextFormat::GRAY . "and gain access to " . TextFormat::AQUA . "color your chat!",
                        TextFormat::GRAY . " ",
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("colorchatc", 1);
                ...
                $sender->sendMessage("Usage: /colorchatc <player>");
            }
        } else {
