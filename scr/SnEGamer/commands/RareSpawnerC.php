...
class RareSpawnerC extends BaseCommand
{
    /** @var Charms */
    private $plugin;
        ...
        if ($sender->hasPermission("charms.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::GREEN . "Rare Spawner" . TextFormat::BOLD . TextFormat::WHITE . " Crate");
                    $lore = [
                        TextFormat::GRAY . "Right-Click to open this crate to",
                        TextFormat::GRAY . "get its rewards!",
                        " ",
                        TextFormat::BOLD . TextFormat::AQUA . "Rewards:",
                        TextFormat::RESET .TextFormat::WHITE . "* 1x Cave Spider Spawner",
                        TextFormat::WHITE . "* 1x Enderman Spawner",
                        TextFormat::WHITE . "* 1x Blaze Spawner",
                        TextFormat::WHITE . "* 1x Guardian Spawner",
                        " ",
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("rares", 1);
                ...
                $sender->sendMessage("Usage: /raresc <player>");
            }
        } else {
